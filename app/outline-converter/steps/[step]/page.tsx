...
export default function OutlineConverterStepPage({ 
  params 
}: { 
  params: { step: string } 
}) {
        ...
        <Card>
          <CardContent className="pt-6">
            ...
            <div className="flex justify-between">
              {prevStep ? (
                <Link href={`/outline-converter/steps/${prevStep}`}>
              ...
              {nextStep && (
                <Link href={`/outline-converter/steps/${nextStep}`}>
                  <Button>
                    Next Step
